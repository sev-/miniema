/*
 * $Id: edef.h,v 1.2 1994/08/15 20:42:11 sev Exp $
 * 
 * ----------------------------------------------------------
 * 
 * $Log: edef.h,v $
...
int stabsize = 0;		       /* current soft tab size (0: use hard
				        * tabs)  */
...
int xpos = 0;			       /* current column mouse is positioned
				        * to */
...
KEYTAB cmdhook;			       /* executed before looking for a
				        * command */
...
extern int stabsize;		       /* current soft tab size (0: use hard
				        * tabs)  */
...
extern int xpos;		       /* current column mouse is positioned
				        * to */
